...
### 1. Определите задачу до поиска иллюстратора

Прежде чем открывать Behance или Reedsy, задайте себе три ключевых вопроса:

#### 1.1. Какой жанр и тональность?

Обложка для романтической комедии и для тёмного фэнтези требуют совершенно разных визуальных языков. Сформулируйте:
- Жанр (sci-fi, fantasy, horror, thriller, romance, literary fiction)
...
Реалистичные ориентиры на рынке в 2026 году:
...
### 2. Где искать иллюстратора обложек
...
Большинство читателей впервые видят обложку в размере 150×200 пикселей на Amazon или в ленте Instagram. Проверьте:
- Читается ли название книги?
- Различим ли главный объект/персонаж?
- Сохраняется ли контраст при уменьшении?
...
- Реальные обложки в продаже (Amazon, Goodreads, ЛитРес)
- Скриншоты из магазинов
- Отзывы от реальных клиентов с именами и ссылками
...
### 6. Процесс работы с иллюстратором: 4 этапа
...
- [ ] Процесс включает эскизы и раунды правок
- [ ] Сроки реалистичны (не «2 дня» для оригинальной работы)
- [ ] Художник задаёт уточняющие вопросы по брифу
- [ ] Указаны технические требования (bleed, CMYK, DPI)
- [ ] Цена соответствует рыночной (не слишком низкая)
- [ ] Коммуникация профессиональная (email, платформа, не только мессенджеры)

---

### 9. Частые ошибки авторов при выборе иллюстратора
...
- Genre (sci-fi, fantasy, horror, thriller, romance, literary fiction)
...
- Is the book title readable?
- Is the main object/character distinguishable?
- Does contrast hold at small sizes?
...
- Real covers for sale (Amazon, Goodreads)
- Store screenshots
- Reviews from real clients with names and links
...
- [ ] Process includes sketches and revision rounds
- [ ] Timeline is realistic (not "2 days" for original work)
- [ ] Artist asks clarifying questions about the brief
- [ ] Technical requirements are specified (bleed, CMYK, DPI)
- [ ] Price matches market rates (not suspiciously low)
- [ ] Communication is professional (email, platform, not just messengers)

---

### 9. Common mistakes authors make when choosing an illustrator

- **Mistake 1:** Choosing by price, not by style. Better to pay 30% more for an artist who understands your genre.
- **Mistake 2:** Not specifying rights in the contract. Always state exclusivity for the book market.
- **Mistake 3:** Trying to please everyone. The cover should appeal to your target audience, not relatives.
- **Mistake 4:** Ignoring typography. Illustration is half the cover; the other half is font and layout.
- **Mistake 5:** Micromanagement. Trust the professional with overall composition; revisions should be strategic.
